...
<AssemblyViewer modelUrl={"/models/support-vermeiden/45-grad.gltf"} allowFloorClip={true} client:visible/>
...
<AssemblyViewer modelUrl={"/models/support-vermeiden/überhang_vergleich.gltf"} allowFloorClip={true} client:visible/>
...
<AssemblyViewer modelUrl={"/models/support-vermeiden/Bauteil aufteilen.gltf"} allowFloorClip={true} client:visible/>
---
...
<AssemblyViewer modelUrl={"/models/support-vermeiden/Supporttypen.gltf"} allowFloorClip={true} client:visible/>
...
<AssemblyViewer modelUrl={"/models/support-vermeiden/Opfer Layer.gltf"} allowFloorClip={true} client:visible/>
