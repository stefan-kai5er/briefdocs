...
Dieser Briefdoc fasst die wichtigsten Konstruktionsprinzipien zusammen, um passgenaue und saubere Bauteile zu erhalten. Er basiert auf den fundamentalen Erkenntnissen aus dem exzellenten Artikel [Design for 3D Printing von Rahix](https://blog.rahix.de/design-for-3d-printing/).
...
## 1. Kanten richtig gestalten: Fasen statt Abrundungen (und umgekehrt)
...
*   **Lösung:** Eine 45-Grad-Fase ist ein selbsttragender Überhang und führt zu einer scharfen und präzisen Kante.
...
Löcher sind im 3D-Druck selten perfekt rund oder maßhaltig. Mit zwei einfachen Tricks im CAD-Design lässt sich dieses Problem elegant lösen.

#### Vertikale Löcher: Die Naht mit einer Tropfenform verstecken
...
#### Horizontale Löcher: Überhänge mit einer Tropfenform stützen
...
## 4. Die Kunst des Einstellens statt Perfektion

Manchmal ist eine höhere Genauigkeit erforderlich, als der Drucker liefern kann.
...
:::success[Erfolg]
*   **Intelligentes Design schlägt Drucker-Tuning:** Anstatt stundenlang den Drucker zu optimieren, löse Passungsprobleme direkt im CAD.
*   **Vermeide Spannungen:** Konstruiere Bauteile so, dass sie nachgeben und Toleranzen ausgleichen können (z.B. bei Presspassungen).
*   **Nutze die Stärken des FDM-Drucks:** 45-Grad-Winkel sind deine Freunde. Nutze sie für Fasen und selbsttragende Öffnungen, um saubere Ergebnisse ohne Stützmaterial zu erzielen.
:::